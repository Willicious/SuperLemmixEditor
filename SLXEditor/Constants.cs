...
namespace SLXEditor
{
        ...
        public static readonly List<Layer> LayerList = new List<Layer>()
    {
      Layer.Background, Layer.Grid, Layer.ObjBack, Layer.Terrain, Layer.ObjTop, Layer.Triggers, Layer.Rulers
        ...
        {
            { TalismanReq.SaveReq, "SAVE_REQUIREMENT" },
            { TalismanReq.TimeLimit, "TIME_LIMIT" },
            { TalismanReq.SkillTotal, "SKILL_LIMIT" },
            { TalismanReq.SkillTypes, "SKILL_TYPE_LIMIT" },
            { TalismanReq.SkillEachLimit, "SKILL_EACH_LIMIT" },
            { TalismanReq.UseOnlySkill, "USE_ONLY_SKILL" },
            { TalismanReq.KillZombies, "KILL_ZOMBIES" },
            { TalismanReq.ClassicMode, "CLASSIC_MODE" },
            { TalismanReq.NoPause, "NO_PAUSE" }
        };
